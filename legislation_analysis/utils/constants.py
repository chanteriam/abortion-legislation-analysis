...
# congress data files
CONGRESS_DATA_FILE_CLEANED_NAME = "congress_legislation_cleaned.fea"
CONGRESS_DATA_FILE_POS_TAGGED_NAME = "congress_legislation_pos.fea"
CONGRESS_DATA_FILE_CLUSTERED_NAME = "congress_legislation_clustered.fea"
...
CONGRESS_DATA_FILE_CLEANED = os.path.join(
    CLEANED_DATA_PATH, CONGRESS_DATA_FILE_CLEANED_NAME
)
...
CONGRESS_DATA_CLUSTERED_FILE = os.path.join(
    CLUSTERED_DATA_PATH, CONGRESS_DATA_FILE_CLUSTERED_NAME
)
