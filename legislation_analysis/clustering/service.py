...
from legislation_analysis.utils.constants import (
    CONGRESS_DATA_FILE_CLUSTERED_NAME,
...
def run_hierarchy_complete_clustering() -> None:
    ...
    congress_hc = HierarchyComplete(
        CONGRESS_DATA_POS_TAGGED_FILE, CONGRESS_DATA_FILE_CLUSTERED_NAME
    )
    ...
    scotus_hc = HierarchyComplete(
        SCOTUS_DATA_FILE_POS_TAGGED, SCOTUS_DATA_FILE_CLUSTERED_FILE_NAME
    )
